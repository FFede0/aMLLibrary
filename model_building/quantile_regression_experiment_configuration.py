...
class QuantileRegressionExperimentConfiguration(ec.ExperimentConfiguration):
    """
    Class representing a single experiment configuration for quantile regression
    ...
    def __init__(self, campaign_configuration, hyperparameters, regression_inputs, prefix):
        ...
        self.technique = ec.Technique.QR
        self._metrics_calculator = Metrics(self._hyperparameters['quantile'])
    ...
    def _compute_signature(self, prefix):
        ...
        signature.append("quantile_" + str(self._hyperparameters['quantile']))
    ...
    def initialize_regressor(self):
        ...
        if not getattr(self, '_hyperparameters', None):
            self._regressor = lm.QuantileRegressor()
        else:
            self._regressor = lm.QuantileRegressor(quantile=self._hyperparameters['quantile'],
